...
class AIMessageContent(BaseModel):
    """Represents a single AI-generated comment."""
    filename: str
    line_number: int
    comment: str
    status: str
...
class AIMessage(BaseModel):
    """Encapsulates the AI response message structure."""
    role: str = Field(..., description="Role of the message, typically 'assistant'.")
    content: List[AIMessageContent] = Field(..., description="List of review comments.")

class ReviewResponse(BaseModel):
    """Expected response format from code reviewer"""
    agent_id: str = Field(..., description="The agent handling this request.")
    output: Dict[str, List[AIMessage]] = Field(..., description="Output messages generated by AI.")
    model: str = Field(..., description="Model used for the response (e.g., gpt-4o).")
    metadata: Dict[str, Any] = Field(..., description="Metadata associated with this response.")
